...
public class ReportsPanel extends VBox {
    ...
    private void createUI() {
        ...
        // ✅ ИСПРАВЛЕНО: Добавлены generic типы для TableColumn
        ...
        // ✅ ИСПРАВЛЕНО: Правильное добавление колонок
    ...
    private VBox createRevenueChart() {
        ...
        for (String day : days) {
            ...
            Pane bar = new Pane();
            bar.setPrefWidth(40);
            // Масштабируем высоту, но ограничиваем максимальную высоту
            double barHeight = Math.min(revenue / 10.0, 150);
    ...
    // Расчет реальной выручки по дням недели
    private Map<String, Double> calculateWeeklyRevenue() {
        ...
        for (Order order : restaurant.getAllOrders()) {
            if (order.getStatus() == OrderStatus.PAID) {
                ...
                String day = days[order.getOrderId() % 7];
